                ...
                <tbody>
                    ...
                    %>
                            <tr>
                                ...
                                <td><a href="../UpdateRoom?hotelName=<%= rs.getString(1) %>&roomType=<%= rs.getString(2) %>&roomSize=<%= rs.getString(3) %>&type=update" class="btn-action btn-update">Update</a></td>
                                <td><a href="../DeleteRoom?hotelName=<%= rs.getString(1) %>&roomType=<%= rs.getString(2) %>&roomSize=<%= rs.getString(3) %>" class="btn-action btn-delete">Delete</a></td>
                            </tr>
                    <%
                            }
