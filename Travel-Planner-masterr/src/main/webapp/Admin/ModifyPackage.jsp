                ...
                <tbody>
                    ...
                    %>
                            <tr>
                                ...
                                <td><a href="../UpdatePackage?package=<%= rs.getString(2) %>&place=<%= rs.getString(3) %>&type=update" class="btn-action btn-update">Update</a></td>
                                <td><a href="../DeletePackage?package=<%= rs.getString(2) %>&place=<%= rs.getString(3) %>" class="btn-action btn-delete">Delete</a></td>
                            </tr>
                    <%
                            }
