				...
				<tbody>
						<%try{
							...
							while(rs.next()){
								...
								<td><%=packagecost %></td>
								<%
								Connection con1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/travelplanner","root","mitesh");
								...
								Connection con2 = DriverManager.getConnection("jdbc:mysql://localhost:3306/travelplanner","root","mitesh");
								...
								Connection con3 = DriverManager.getConnection("jdbc:mysql://localhost:3306/travelplanner","root","mitesh");
								...
								Connection con4 = DriverManager.getConnection("jdbc:mysql://localhost:3306/travelplanner","root","mitesh");
